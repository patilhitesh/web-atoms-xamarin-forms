		...
		public App ()
		{
            ...
            Device.BeginInvokeOnMainThread(async () => {
                try
                {
                    ...
                    await AtomBridge.Instance.ExecuteScriptAsync("https://v2018-test.800casting.com/uiv/ts-apps@1.0.75/dist/xf/Admin?platform=xf");                   // var val = AtomBridge.Instance.engine.Global.Get("Promise");
